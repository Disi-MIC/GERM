 ...
 * limité aux rôles RH : ROLE_SUPERADMIN n'est jamais délégable (garde-fou
 * anti-élévation de privilège assuré par le typage lui-même).
 * Les valeurs sont exactement les constantes de rôle de App\Entity\User.
 */
enum RoleDelegable: string
{
    case RH_RESPONSABLE = 'ROLE_RH_RESPONSABLE';
    ...
    {
        return match ($this) {
            self::RH_RESPONSABLE => 'Responsable RH (accès global)',
